...
class ClientProductController extends Controller
{
    ...
    public function viewpdf($id)
    {
     ...
     public function mailPdf($id)
     {
         ...
         Mail::send('emails.myTestMail', $clientproduct, function ($message) use ($clientproduct, $pdf, $client) {
             $message->to($client[0]["email"], $client[0]["email"])
                     ->subject("Mail from Test Mail")
